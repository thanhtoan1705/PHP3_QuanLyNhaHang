											...
											<table id="empoloyees-tbl" class="table">
												...
												<tbody>
													...
													<tr>
														...
														<td><img src="{{ asset('storage/images/' . $item->image) }}" alt="" width="75px" height="100px"></td>
														<td><span>{{$item->phone}}</span></td>
														<td><span class="badge badge-rounded badge-outline-primary badge-lg">{{$item->address}}</span></td>
														<td><span>{{$item->position}}</span></td>
														<td><span class="text-primary font-w500">{{$item->salary}}</span></td>
														<td>
															<div class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-right" style="">
																	<a class="dropdown-item" href="{{ route('staff.edit', $item->id)}}">Sửa</a>
																	<a class="dropdown-item" href="{{ route('staff.delete', $item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa')">Xóa</a>
																</div>
															</div>
														</td>
													</tr>
