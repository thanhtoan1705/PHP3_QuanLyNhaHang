                                        ...
                                        <table id="empoloyees-tbl" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span>1</span></td>
                                                    <td><span>Cuong</span></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('assets/admin/images/contacts/pic1.jpg') }}"
                                                                class="avatar avatar-xxs rounded" alt="">
                                                            <p class="mb-0 ms-2">Cuong</p>
                                                        </div>
                                                    </td>
                                                    <td><span>03542336542</span></td>

                                                    <td><span>Can tho</span></td>
                                                    <td><span>Nhân viên</span></td>
                                                    <td><span>1.000.000vnđ</span></td>
                                                    <td>
                                                        <div class="dropdown">
