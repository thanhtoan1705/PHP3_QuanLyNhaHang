                ...
                <ul class="revnue-tab nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="status-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true">Hoạt
                            động</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="inactive-tab" data-bs-toggle="tab" data-bs-target="#inactive-tab-pane"
                            type="button" role="tab" aria-controls="inactive-tab-pane" aria-selected="false">Không hoạt
                            động</button>
                    </li>
                </ul>
                <div>
                            ...
                            <div class="card mt-2">
                                <div class="card-body p-0">
                                    <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
                                        ...
                                        {{ $users->appends(['page_inactive' => request('page_inactive')])->links() }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-2">
                                <div class="card-body p-0">
                                    <div class="table-responsive active-projects style-1 ItemsCheckboxSec shorting ">
                                            ...
                                            <tbody>
                                                @foreach ($usersInactive as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td><span>{{ $usersInactive->firstItem() + $index }}</span></td>
                                                        <td><span>{{ $item->name }}</span></td>
                                                        <td><span>{{ $item->email }}</span></td>
                                                        <td><span>{{ $item->phone }}</span></td>
                                                        <td><span>{{ $item->address }}</span></td>
                                        ...
                                        {{ $usersInactive->appends(['page_active' => request('page_active')])->links() }}
                                    </div>
                                </div>
                            </div>
                        </div>
