                                ...
                                <div class="row">
                                    <div class="col-lg-4 order-lg-2 mb-4">
                                        ...
                                        <ul class="list-group mb-3">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                <div>
                                                    <h6 class="my-0">Sản phẩm thứ 2</h6>
                                                    <small class="text-muted">Brief description</small>
                                                </div>
                                            ...
                                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                <div>
                                                    <h6 class="my-0">Sản phẩm thứ 3</h6>
                                                    <small class="text-muted">Brief description</small>
                                                </div>
                                        ...
                                        <form>
                                            <div class="input-group">
												...
												<button type="submit" class="input-group-text">Chuộc lại</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-lg-8 order-lg-1">
                                        ...
                                        <form class="needs-validation" novalidate="">
                                            ...
                                            <div class="form-check custom-checkbox mb-2">
                                                ...
                                                <label class="form-check-label" for="same-address">Địa chỉ giao hàng
                                                    là
                                                    giống như
                                                    địa chỉ thanh toán của tôi</label>
                                            </div>
                                            <div class="form-check custom-checkbox mb-2">
                                                <input type="checkbox" class="form-check-input" id="save-info">
                                                <label class="form-check-label" for="save-info">Lưu cái này
                                                    thông tin
                                                    cho tiếp theo
                                                    thời gian</label>
                                            </div>
                                            ...
                                            <hr class="mb-4">
                                            <button class="btn btn-primary btn-lg btn-block" type="submit">Tiếp tục
                                                Thủ tục thanh toán</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
