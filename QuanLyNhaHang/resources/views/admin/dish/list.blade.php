                                    ...
                                    <div class="card-header flex-wrap border-0">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <select name="price" class="form-control ms-2">
                                                ...
                                                <option value="0-50000" {{ request('price') == '0-50000' ? 'selected' : '' }}>0 - 50,000 VNĐ</option>
                                                <option value="50000-100000" {{ request('price') == '50000-100000' ? 'selected' : '' }}>50,000 - 100,000 VNĐ</option>
                                                <option value="100000-200000" {{ request('price') == '100000-200000' ? 'selected' : '' }}>100,000 - 200,000 VNĐ</option>
                                                <option value="200000-500000" {{ request('price') == '200000-500000' ? 'selected' : '' }}>200,000 - 500,000 VNĐ</option>
                                                <option value="500000" {{ request('price') == '500000' ? 'selected' : '' }}>500,000 VNĐ trở lên</option>
                                            </select>
