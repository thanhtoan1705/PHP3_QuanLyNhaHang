                ...
                <nav aria-label="breadcrumb text-center">
                    ...
                    <ol class="breadcrumb text-center">
                        <li class="breadcrumb-item"><a href="/">Trang chủ </a> / <a
                                href="{{ route('blogDetail') }}">Chi tiết bài viết </a></li>
                    </ol>
                </nav>
            </div>
        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 margin-bottom-30">
                                                    <div class="single-image image-2">
                                                        <img src="{{ asset('admin/assets/images/blog/blog5.jpg') }}"
                                                            alt="image">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="single-image ">
                                                        <img src="{{ asset('admin/assets/images/blog/blog6.jpg') }}"
                                                            alt="image">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="single-image image-2">
                                                        <img src="{{ asset('admin/assets/images/blog/blog7.jpg') }}"
                                                            alt="image">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="blog-social-icons">
                                                <ul>
                                                    ...
                                                    <li><a href="#"><img
                                                                src="{{ asset('admin/assets/images/icons/facebook.png') }}"
                                                                alt=""></a>
                                                    </li>
                                                    <li><a href="#"><img
                                                                src="{{ asset('admin/assets/images/icons/twitter.png') }}"
                                                                alt=""></a>
                                                    </li>

                                                    <li><a href="#"><img
                                                                src="{{ asset('admin/assets/images/icons/inst.png') }}"
                                                                alt=""></a>
                                                    </li>
                                                    <li><a href="#"><img
                                                                src="{{ asset('admin/assets/images/icons/linkdin.png') }}"
                                                                alt=""></a>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="blog-comment-form margin-top-60  wow fadeInUp">
                            <div class="comment-title">
                                ...
                                <form action="#">
                                    ...
                                    <textarea name="message" placeholder="Write your text" id="comment-form" cols="30" rows="10"></textarea>
