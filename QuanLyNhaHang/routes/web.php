...
Route::get('table-book', [TableController::class, 'list'])->name('table-book.list')->middleware(['auth', 'role:admin']);
Route::get('table-book/add', [TableController::class, 'add'])->name('table-book.add')->middleware(['auth', 'role:admin']);
Route::get('table-book/edit', [TableController::class, 'edit'])->name('table-book.edit')->middleware(['auth', 'role:admin']);
